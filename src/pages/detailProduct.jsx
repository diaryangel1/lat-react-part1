// up60 MEMBUAT PAGE BARU DETAILPRODUCT
//up62 menangkap fungsi parameter use params menggunakan react-router-dom dan langsung destructuring
...
const DetailProductPage = () => {
  ...
  // up64 memanggil getdetailproduct dengan useEffect dengan dependencies id untuk menjalankan getdetailproduct
  useEffect(() => {
  ...
  return (
    // up67 membuat card product dari tailwind template dan mengubah srcnya sesuai id dan render object.keys dari product
    <div className="bg-white w-100 min-h-screen flex justify-center items-center">
